...
关于教材，大部分数院的教材以及我提到的参考教材都可以找到电子书，教材通常可以找学长学姐获得。如果有空，我也会整理这些教材并且分享一些电子书的获取方式。如果有需要，欢迎和我单独联系。
...
**学习建议**：考试内容基本集中于如何求解方程，因此需要多做题目来掌握求解方程的方法和技巧。定性理论部分取决于上课内容和考试范围，这里没法简单给出建议。
